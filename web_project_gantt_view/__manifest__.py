...

{
    ...
    "assets": {
        "web.assets_backend": [
            ...
            "/web_project_gantt_view/static/src/css/gantt.css",
            "/web_project_gantt_view/static/src/js/gantt_renderer.js",
            "/web_project_gantt_view/static/src/js/gantt_view.js",
            "/web_project_gantt_view/static/src/js/gantt_model.js",
            "/web_project_gantt_view/static/src/js/gantt_controller.js",
        ],
        "web.assets_qweb": [
            'web_project_gantt_view/static/src/xml/*.xml',
        ]
    },
    "installable": True,
    "application": True,
