...
class HrSalaryRule(models.Model):
    ...
    name = fields.Char(required=True, translate=True)
    code = fields.Char(required=True, related="category_id.code",
    ...
    amount_percentage_payslip = fields.Float('Amount Percentage Payslip(%)')
    amount_fix_payslip = fields.Float('Fixed Amount')
    amount_type = fields.Selection([
        ('percentage', 'Percentage (%)'),
        ('fix', 'Fixed Amount'),
    ], string='Payslip Amount Type',required=True, default='percentage')
