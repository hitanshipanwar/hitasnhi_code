...
class SaleOrder(models.Model):
    ...
    def _get_reward_values_discount(self, program):
        print("UUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU",program)
    ...
    def _create_reward_line(self, program):
        ...
        print("8888888888888888888888888888888888",self._get_reward_line_values(program))
        ...
        if order:
            ...
            for line in order.order_line:
                if line.product_id.installer_solar_id:
                    ...
                    print(total,"aaaaaaaaaaaaaaaaaa",line.product_id.list_price)
        for jk in values:
                ...
                for value in values:
                    ...
                    if not value_found:
                        ...
                        if program.is_bid_coupon:
                            ...
                            print("hhhhhhhhhhhhhhhhhhhhhhhhhhhh",program)
