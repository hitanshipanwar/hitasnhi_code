...
class CustomerPortal(CustomerPortal):
    ...
    def _prepare_portal_layout_values(self):
        ...
        ids = request.env["dms.file"].search([("is_hidden", "=", False)])
        ids = ids.filtered(lambda f: f.file_visibility)
    ...
    def portal_my_dms(
        ...
        dms_file_items = dms_file_items.filtered(lambda f: f.file_visibility)
        # values
        values.update(
            {
                "dms_files": dms_file_items,
                "dms_directories": None,
