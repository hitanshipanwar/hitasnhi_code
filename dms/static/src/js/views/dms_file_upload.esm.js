...
//        }
        ...
        console.log("============onUpload======attachments_args====",attachments_args);
        ...
        rpc.query({
            ...
            .catch((error) => {
                ...
                window.alert(this.env._t(error.message.data.message));
//                window.alert(this.env._t("A file with the same name already exists."));
                self.notification.add(
                    this.env._t("No directory exist for Document"),
