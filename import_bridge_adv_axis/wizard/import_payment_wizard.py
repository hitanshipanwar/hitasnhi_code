    ...
    def import_client_payment(self):
        if self.file_option == 'csv':
            ...
            for line in csv_reader:
                ...
                payment_methods = (float(line.get('Payment Amount')) > 0) and journal.inbound_payment_method_line_ids or journal.outbound_payment_method_line_ids
            ...
            for row in xls_reader:
                ...
                payment_methods = (float(line.get(
                    'Payment Amount')) > 0) and journal.inbound_payment_method_line_ids or journal.outbound_payment_method_line_ids
