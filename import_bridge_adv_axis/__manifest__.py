# -*- coding: utf-8 -*-
{
    'name': "Advance Data Import for Sales,Purchase,POS,Chart Account,Invoice,Inventory,Products,Product Images",
    ...
    'depends': ['base','sale_management','sale','account','purchase','stock','mrp','point_of_sale','hr','project','hr_attendance'],
    'data': [
        ...
        'wizard/import_attendance_wizard_view.xml',
