...
import BarcodeAisleModel from '@o2b_stock_custom/js/model/barcode_aisle_model';
...
class BarcodeAisleComponent extends Component {
    //--------------------------------------------------------------------------
    // Lifecycle
    //--------------------------------------------------------------------------
    ...
    setup() {
        ...
        this.props.model = this.props.action.params.res_model;
        this.props.id = this.props.action.context.active_id;
        console.log('----',this.props)
        console.log('----',this.props.action.params.res_model)
...
//            '/stock_barcode/get_barcode_aisle_data',
//            {
...
BarcodeAisleComponent.template = 'o2b_stock_custom.BarcodeAisleComponent';
BarcodeAisleComponent.components = {
...
registry.category("actions").add("stock_barcode_aisle_client_action_tag", BarcodeAisleComponent);

export default BarcodeAisleComponent;
