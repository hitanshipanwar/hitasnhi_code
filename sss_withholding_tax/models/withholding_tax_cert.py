...
WHT_CERT_INCOME_TYPE = [
    ...
    (
        "4B12",
        "4. (1) กรณีผู้ด้รับเงินปันผลได้รับเครดิตภาษี โดยจ่ายจาก"
        "กำไรสุทธิของกิจการที่ต้องเสียภาษีเงินได้นิติบุคคลในอัตราดังนี้",
    ),
    (
        "4B14",
        "4. กรณีผู้ด้รับเงินปันผลได้รับเครดิตภาษี โดยจ่ายจาก กำไรสุทธิของกิจการที่ต้องเสียภาษีเงินได้นิติบุคคลในอัตราดังนี้ (1.1) อัตราร้อยละ 30 ของกำไรสุทธิ "
    ),
    (
        "4B21",
        "4. กรณีผู้ด้รับเงินปันผลได้รับเครดิตภาษี โดยจ่ายจาก กำไรสุทธิของกิจการที่ต้องเสียภาษีเงินได้นิติบุคคลในอัตราดังนี้ (1.2) อัตราร้อยละ 25 ของกำไรสุทธิ "
    ),
    (
        "4B22",
        "4. กรณีผู้ด้รับเงินปันผลได้รับเครดิตภาษี โดยจ่ายจาก กำไรสุทธิของกิจการที่ต้องเสียภาษีเงินได้นิติบุคคลในอัตราดังนี้ (1.3) อัตราร้อยละ 20 ของกำไรสุทธิ "
    ),
    (
        "4B23",
        "4. กรณีผู้ด้รับเงินปันผลได้รับเครดิตภาษี โดยจ่ายจาก กำไรสุทธิของกิจการที่ต้องเสียภาษีเงินได้นิติบุคคลในอัตราดังนี้ (1.4) อัตราอื่น ๆ ( ระบุ )             ของกำไรสุทธิ "
    ),
    (
        "4B24",
        "4. (2) กิจการที่ได้รับยกเว้นภาษีเงินได้นิติบุคคลซึ่ง ผู้รับเงินปันผลไม่ได้รับเครดิตภาษี"
    ),
    (
        "4B25",
        "4. กิจการที่ได้รับยกเว้นภาษีเงินได้นิติบุคคลซึ่ง ผู้รับเงินปันผลไม่ได้รับเครดิตภาษี (2.1) กำไรสุทธิของกิจการที่ได้รับยกเว้นภาษีเงินได้นิติบุคคล"
    ),
    (
        "4B26",
        "4. กิจการที่ได้รับยกเว้นภาษีเงินได้นิติบุคคลซึ่ง ผู้รับเงินปันผลไม่ได้รับเครดิตภาษี (2.2) เงินปันผลหรือเงินส่วนแบ่งของกำไรที่ได้รับยกเว้นไม่ต้องนำมารวม"
        "คำนวณเป็นรายได้เพื่อเสียภาษีนิติบุคคล",
    ),
    (
        "4B27",
        "4. กิจการที่ได้รับยกเว้นภาษีเงินได้นิติบุคคลซึ่ง ผู้รับเงินปันผลไม่ได้รับเครดิตภาษี (2.3) กำไรสุทธิส่วนที่ได้หักผลขาดทุนสุทธิยกมาไม่เกิน 5 ปี"
        "ก่อนรอบระยะเวลาบัญชีปัจจุบัน",
    ),
    (
        "4B28",
        "4. กิจการที่ได้รับยกเว้นภาษีเงินได้นิติบุคคลซึ่ง ผู้รับเงินปันผลไม่ได้รับเครดิตภาษี (2.4) กำไรที่รับรู้ทางบัญชีโดยวิธีส่วนได้เสีย (equity method)"
    ),
    (
        "4B29",
        "4. กิจการที่ได้รับยกเว้นภาษีเงินได้นิติบุคคลซึ่ง ผู้รับเงินปันผลไม่ได้รับเครดิตภาษี (2.5) อัตราอื่น ๆ ( ระบุ )"
    ),
    ("5", "5. การจ่ายเงินได้ที่ต้องหักภาษี ณ. ที่จ่าย ตามคำสั่งกรมสรรพากรที่ออกตาม"
        "มาตรา 3 เตรส เช่น รางวัล ส่วนลดหรือประโยชน์ใดๆ เนื่องจากการส่งเสริมการขาย"
        "รางวัลในการประกวด การแข่งขัน การชิงโชค ค่าแสดงของนักแสดงสาธารณะ"
        "ค่าบริการ ค่าขนส่ง ค่าจ้างทำของ ค่าจ้างโฆษณา ค่าเช่า ค่าเบี้ยประกันวินาศภัย ฯลฯ",),
    ("6", "6. อื่นๆ(ระบุ)"),
]
...
class WithholdingTaxCert(models.Model):
    ...
    total_tax_amount = fields.Float('Tax Amount', compute="_compute_total_tax_amount")
    total_tax_percent = fields.Float('% Tax', compute="_compute_total_tax_percent")
    total_base = fields.Float('Base Amount', compute="_compute_total_base")
    other_income_desc = fields.Char('Other Description')
    type_of_income = fields.Selection(selection=WHT_CERT_INCOME_TYPE)

    def _get_report_base_filename(self):
        print("_get_report_base_filename >>>>>>>>>>>>>>>>>>>>>>>")
        self.ensure_one()
        res = "WT Certificates - {}".format(self.display_name)
        print("res >>>>>>>>>>>>>>", res)
        return res
    ...
    def _compute_wt_cert_data(self):
        ...
        if wt_account_ids:
            ...
            for record in self:
                ...
                # wt_tx_id = []
                # for l in wt_move_lines:
                #     if l.wt_tax_id.id not in wt_tx_id:
                #         wt_tx_id.append(l.wt_tax_id.id)
                #         print('---------------------wt_tx_idwt_tx_id------',wt_tx_id)
                
                # wt_cer_lines = []
                # for line in wt_move_lines:
                #     wt_cer_lines.append(record._prepare_wt_line(line))
                #     print('======wt_cer_lines=============================',wt_cer_lines)
                # final_wt_cer_line = []
                # for wti in wt_tx_id:
                #     for wt_c_l in wt_cer_lines:
                #         if wt_c_l.get("wt_tax_id") == wti:
                #             if final_wt_cer_line:
                #                 flag = True
                #                 for f_c_l in final_wt_cer_line:
                #                     if f_c_l.get("wt_tax_id") == wt_c_l.get("wt_tax_id"):
                #                         f_c_l["amount"] = f_c_l["amount"] + wt_c_l["amount"]
                #                         f_c_l["base"] = f_c_l["base"] + wt_c_l["base"]
                #                         flag = False
                #                 if flag:
                #                     final_wt_cer_line.append(wt_c_l)
                #             else:
                #                 final_wt_cer_line.append(wt_c_l)
                #             print('******final_wt_cer_line*******************************',final_wt_cer_line)
                # for line in final_wt_cer_line:
                    # record.write({'wt_line':[(0,0,line)]})
                for line in wt_move_lines:
                    record.write({'wt_line':[(0,0,record._prepare_wt_line(line))]})
                    # record.wt_line = CertLine.new(record._prepare_wt_line(line))
                    # CertLine.new(record._prepare_wt_line(line))

    def _compute_total_tax_amount(self):
        for wt in self:
            for cart_line in wt.wt_line:
                wt.total_tax_amount += cart_line.amount

    def _compute_total_tax_percent(self):
        for wt in self:
            for cart_line in wt.wt_line:
                wt.total_tax_percent += cart_line.wt_percent

    def _compute_total_base(self):
        for wt in self:
            for cart_line in wt.wt_line:
                wt.total_base += cart_line.base
    @api.model
    def _prepare_wt_line(self, move_line):
        """Hook point to prepare wt_line"""
        wt_percent = abs(move_line.wt_tax_id.amount)
        ...
        vals = {
            ...
            "wt_percent": abs(wt_percent),
            # "base": (abs(move_line.balance) / wt_percent * 100)
            "base": abs(move_line.balance)
            if wt_percent
            else False,
            # "amount": abs(move_line.balance),
            # "amount": (abs(move_line.balance) / wt_percent * 100),
            "amount": (abs(move_line.balance) * wt_percent / 100),
            "ref_move_line_id": move_line.id,
            'wt_tax_id':move_line.wt_tax_id.id or False
        }
        return vals
    ...
    def _get_wth_cert_model_view(self):
        ...
        view = "sss_withholding_tax.create_withholding_tax_cert"
        if len(self._context.get("active_ids")) > 1:
            view = "sss_withholding_tax.create_withholding_tax_cert_multi"
        view_id = self.env.ref(view).id
        return res_model, view_id

    def action_create_withholding_tax_cert(self):
        # print('--action_create_withholding_tax_cert-----------------------',action_create_withholding_tax_cert)
...
class WithholdingTaxCertLine(models.Model):
    ...
    wt_tax_id = fields.Many2one(comodel_name="account.withholding.tax", string="WT",store=True)
    ...
    def _onchange_wt_percent(self):
        if self.wt_percent:
            ...
            self.base = self.amount *  self.wt_percent / 100
        else:
            self.base = 0.0
