...
class ShopifyQueueProcessEpt(models.TransientModel):
    ...
    def process_order_queue_manually(self):
        ...
        # ===================O2B====================
        # if order_queue_ids:
        #     order_queue_ids_list = [queue.id for queue in order_queue_ids]
        #     _logger.info("Order Queues ids %s " % order_queue_ids_list)
        #     order_queue_data_obj.process_order_queue_data(order_queue_ids_list)
        # ===================O2B====================
